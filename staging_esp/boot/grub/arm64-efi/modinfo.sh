...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=ARM64_EFI -nostdinc -isystem /usr/lib/gcc/aarch64-alpine-linux-musl/14.2.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
